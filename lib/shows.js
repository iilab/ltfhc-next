...
exports.reports = function(doc, req) {
    events.once('afterResponse', function() {
        ...
        function renderTable(table, report, report_periods, docs) {
            var datatable_options = {
                "oLanguage": {
                    "sLengthMenu": "_MENU_ " +
        ...
        function showTable(item) {
            ...
            var q = {
                ...
                endkey: [report, report_periods[11].start],
                descending: true,
                include_docs: true
            };
            db.getView(ddoc, view, q, function (err, data) {
                ...
                renderTable(table, report, report_periods, docs);
            });
        }
