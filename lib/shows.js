...
exports.patients_table = function(doc, req) {
	...
	return {
		...
		content: templates.render('patients_table.html', req, props)
	};
};
...
exports.visits_table = function(doc, req) {
	events.once('afterResponse', function() {

		utils.updateTopNav('visits', null);
		...
		setupContext(req, function(err) {
			...
			$('#patients-table').dataTable({
				//"sDom": "<'#patients-table'<'row-fluid'<'span10'f><'span2'l>r>>t<'#patient_footer'<'row-fluid'<'span7'p><'span5'i>>>",
				"aLengthMenu": [
					[8, 25, 50, -1],
					[8, 25, 50, "All"]
				],
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "../_list/datatables/visits",
				"aoColumns": [{
					"sTitle": "First Name"
				}, {
					"sTitle": "Last Name"
