...
exports.reports = function(doc, req) {
    events.once('afterResponse', function() {
        ...
        function renderTable(table, docs) {
            var datatable_options = {
                "oLanguage": {
                    "sLengthMenu": "_MENU_ " +
        ...
        function showTable(item) {
            ...
            $('#reports .caret').addClass('caret-right');
            $('#reports .spin-box').hide();
            $('#reports .dataTables_wrapper').replaceWith(
            ...
            db.getView(ddoc, view, q, function (err, data) {
                ...
                $('.spin-box', item).hide();
                // clear table and display it
                table.html('').show();
                var docs = _.map(data.rows, function (row) {
                    return row.doc;
                });
                renderTable(table, docs);
            });
        }
