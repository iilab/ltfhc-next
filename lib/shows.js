				...
				var datatable_options = {
					...
					"aoColumns": [{
						...
						"mRender": function(data, type, full) {
							...
							return '<a class="btn btn-primary" href="' + baseURL + '/patient/' + full._id + '"><i class="icon icon-edit"> Edit</a>';
						}
					}]
				}
...
exports.visit_new = function(doc, req) {
	events.once('afterResponse', function() {
				...
				var datatable_options = {
					...
					"aoColumns": [{
						...
						"mRender": function(data, type, full) {
							// 'full' is the row's data object, and 'data' is this column's data
							// e.g. 'full[0]' is the comic id, and 'data' is the comic title
							return '<a class="btn btn-primary" href="' + baseURL + '/patient/' + full.patient_id + '"><i class="icon icon-user"> Edit</a>';
						}
					}, {
						"sTitle": "Edit Visit",
						"mData": "visit_id",
						"mRender": function(data, type, full) {
							// 'full' is the row's data object, and 'data' is this column's data
							// e.g. 'full[0]' is the comic id, and 'data' is the comic title
							return '<a class="btn btn-primary" href="' + baseURL + '/visit/' + full.patient_id + "/" + full._id + '"><i class="icon icon-list"> Edit</a>';
						}
					}]
				}
				datatable_options.aaData = docs
