				...
				var datatable_options = {
					...
					"aoColumns": [{
						...
						"mRender": function(data, type, full) {
							// 'full' is the row's data object, and 'data' is this column's data
							// e.g. 'full[0]' is the comic id, and 'data' is the comic title
							return '<a href="' + baseURL + '/patient/' + full.patient_id + '"><i class="icon icon-lg icon-user"></a>';
						}
					}, {
						"sTitle": "Edit Visit",
						"mData": "visit_id",
						"mRender": function(data, type, full) {
							// 'full' is the row's data object, and 'data' is this column's data
							// e.g. 'full[0]' is the comic id, and 'data' is the comic title
							return '<a href="' + baseURL + '/visit/' + full.patient_id + "/" + full._id + '"><i class="icon icon-lg icon-list"></a>';
						}
					}]
				}
				datatable_options.aaData = docs
