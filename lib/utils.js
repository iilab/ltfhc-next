...
exports.createReport = function(report_ids, date, callback) {
    ...
    var prefix = moment(date).format("YYYY-MM").split("-");
    ...
    function (err, subreports) {
        ...
        var doc_report = {
            ...
            period: moment(date).format('MMMM YYYY')
        };
        ...
        db.saveDoc(doc_report, function(err, res) {
            if (err) {
                console.log(err)
                console.log("Error with scheduled trigger")
                console.log(err)
                console.log("With doc_report " + report)
                console.log(doc_report)
            }
            else {
                console.log("Scheduled trigger for doc_report " + doc_report.report)
                console.log(doc_report)

                db.getDoc("schedule_" + doc_report.report, function(e,schedule_doc) {
                    if (e && e.error === "not_found") {
                        schedule_doc = {
                            _id: "schedule_" + doc_report.report,
                            class: "entry",
                            collection: "schedule",
                            doc_collection: "reports",
                            date_scheduled: moment().add(1, 'months').startOf('month')
                        }
                    }
                    else if (e) {
                        console.log(e)
                        ...
                        schedule_doc.date_scheduled = moment().add(1, 'months').startOf('month')
                    }
