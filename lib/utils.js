...
exports.updateDate = function(doc, field_name, period, date_overwrites) {

	date_overwrites = date_overwrites || true
...
//	console.log("field_name:" + field_name + "/period:" + period)
	...
	try {
		if (date_overwrites) { // when set date takes precedence
