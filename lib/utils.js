...
exports.updateDate = function(doc, field_name, period) {
...
//	console.log("field_name:" + field_name + "/period:" + period)
	...
	try {
		if (doc["date_" + field_name]) { // when set date takes precedence
		...
		}	else if (doc["current_" + field_name + "_" + period]) { // only an approximate age
			...
			throw "date_" + field_name + " or current_" + field_name + "_" + period + " fields don't exist:" 
		}				
	}
	catch (err) {
		console.log(err)		
