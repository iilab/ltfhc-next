...
exports.updateDate = function(doc, current_value, current_field_name, period) {
...
exports.updateCurrent = function(doc, date_value, date_field_name, period) {
  ...
  doc["current_" + date_field_name + "_" + period ] = current
	scheduleDate(doc._id, date_field_name, date, current, period)

	return doc

}

var scheduleDate = function (id, field_name, date, current, period) {
	...
	db.getDoc("schedule_" + field_name + "_" + id, function(e,schedule_doc) {
		if (e && e.error === "not_found") {
            schedule_doc = {
				...
				collection: "schedule",
				doc_scheduled: id,
				field: "current_" + field_name + "_" + period 
			}
        }
        else if (e) {
            console.log(e)
