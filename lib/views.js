						...
						try {
							with(doc){
								...
								if (typeof result === "undefined" || result === null) { 
									...
									if (result) {
										emit([report, reports[report].properties[indicator].line_number, reports[report].properties[indicator].en, bucket, result ], {report: report, line_number: reports[report].properties[indicator].line_number, indicator: reports[report].properties[indicator].en, bucket: bucket})										
									}
								}
							}
						} catch (e) {
