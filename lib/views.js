...
//			emit([reports_anc.properties.gestational_age_below_12_weeks.en])
			emit([(doc.anc_first_visit.gestational_age < 12) ? "gestational_age_below_12_weeks" : "gestational_at_week_12_or_more", bucket])
			emit([(doc.anc_first_visit.gestational_age) ? "total_attendance_of_first_visits(2a+2b)" : null, bucket])

			emit([(doc.anc_first_visit.pregnancy_test) ? "number_of_pregnant_women_tested_first_visit" : null, bucket])
