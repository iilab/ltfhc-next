				...
				for (indicator in reports[report].properties) {
					...
					if (cdtn && reports[report].properties[indicator].line_number) {
						try {
							with(doc){
								...
								if (typeof result === "undefined" || result === null) { 
									...
									if (result) {
										emit([report, reports[report].properties[indicator].line_number, reports[report].properties[indicator].en, bucket, result ], { bucket: bucket})										
									}
								}
							}
						} catch (e) {
						...
						if (reports[report].properties[indicator].line_number != null && reports[report].properties[indicator].en != null ) {
							emit([report, reports[report].properties[indicator].line_number, reports[report].properties[indicator].en, "header", "" ], { bucket: "header"})	
						} else {
