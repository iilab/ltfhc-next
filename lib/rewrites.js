module.exports = [
    ...
    {from: '', to: '_show/patients'},
		...
		{from: '/patient', to: '_show/patient_new'}, // showing empty patient form
		{from: '/patient/', to: '_show/patient_new'}, // alias to empty patient form
    ...
    {from: '/patients', to: '_show/patients'}, // showing patient table
		...
		{from: '/visit/:patient_id', to: '_show/visit_new', query: { patient_id: ':patient_id' }},
    ...
    {from: '/visits', to: '_show/visits'},
		...
		{from: '/report/:id', to: '_show/report/:id'}, // showing existing patient
