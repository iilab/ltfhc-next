module.exports = [
    ...
    {from: '/patients_table', to: '_show/patients_table'},
    {from: '/users', to: '_show/users'},
    {from: '/visits', to: '_show/visits'},
    {from: '/visits_table', to: '_show/visits_table'},
    {from: '/reports', to: '_show/reports'},
    {from: '/reports_entries', to: '_show/reports_entries'},
    {from: '/reports_calculated', to: '_show/reports_calculated'},
